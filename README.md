...
- In general this website consists of a header, content with images, buttons and icons, and a footer. Users can be directed to (social) media websites through the footer. The website has a responsive design and was built in GidPod and hosted by Heroku. Documentation is present. 
...
- Direct a user back to the page where he was, after deleting an image:
